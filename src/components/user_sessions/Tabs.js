...
const exportToExcel = (formatter, params, pages) => {
  ...
  const selected_columns = ['page', 'section', 'row', 'views', 'leads', 'sales', 'pixels', 'cr', 'pixels_cr', 'pixels_ratio', 'releads',  'resubs', 'active24', 'cq', 'ecpa', 'cpa',  'cost', 'revenue', 'total', 'billed', 'epc']
