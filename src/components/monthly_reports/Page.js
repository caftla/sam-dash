      ...
      { !chart_data
        ...
        : <div>
          <div className="chart-container" style={chart_container_styles}>
            <div className="chart-title" style={{ ...chart_title_styles, height: '360px' }}><h4 style={ chart_title_h4_styles }>ARPU / eCPA and Sales</h4></div>
            <ARPUChart data={chart_data.data} />
          </div>
          <div className="chart-container" style={chart_container_styles}>
            <div className="chart-title" style={{ ...chart_title_styles, height: '230px' }}><h4 style={ chart_title_h4_styles }>Breakeven</h4></div>
    ...
    return <div>
      <TABLE width={1020} style={{marginTop: '1em'}} data-id={ page }>
        ...
        <TBody>
          ...
          <Row label='CPA' f={format_null(x => x.cost / x.pixels, d3.format('0.2f'))} />
          ...
          <Row label='ARPU 14' f={format_null(R.prop('arpu_week_2'), format_arpu)} />
          ...
          <Row label='Total Unsubscribes' f={format_null(R.prop('optouts'), d3.format(','))} />
