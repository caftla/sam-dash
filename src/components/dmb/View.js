    ...
    columns={[
      ...
      },
      {
        ...
        columns: [
          ...
          mkPercentMetric(
            "Advance in Pre-Flow",
            "pre_flow_advance_events_rate",
            "pre_flow_advance_events",
            "impressions"
          ),
          ...
          mkPercentMetric(
            "In Target",
            "in_targetted_ips_ranges_rate",
            "in_targetted_ips_ranges",
            "impressions"
          ), 
          
          mkPercentMetric(
            "In Target And Advanced in Flow",
            "in_targetted_ips_ranges_and_advanced_in_flow_rate",
            "in_targetted_ips_ranges_and_advanced_in_flow",
            "impressions"
          ), 
