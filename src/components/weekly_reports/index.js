...
import {
  ...
  , fetch_weekly_reports, cleanup_fetch_weekly_reports
...
import weekly_reports_selector from '../../selectors/weekly_reports.js'
...
const make_path = (params, query) => `/weekly_reports/${params.date_from}/${params.date_to}/${params.filter}/${params.page}/${params.section}/${params.row}${query}`


export default connect(
    state => ({
        data: weekly_reports_selector(state)
  ...
  , {
        fetch_all_countries
      , fetch_all_affiliates
      , fetch_data: fetch_weekly_reports
      , cleanup_fetch_data: cleanup_fetch_weekly_reports
      , sort_row_filter_page_section_row, sort_row_filter_page_section, min_row_filter_page_section_row
      , set_params 
    }
