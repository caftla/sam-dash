...
export default class Controls extends React.Component {
  ...
  render() {
    ...
    const breakdown_list = [ 'affiliate_id', 'publisher_id', 'sub_id', 'gateway', 'country_code', 'operator_code', 'handle_name', 'ad_name', 'scenario_name', 'product_type', 'service_identifier1', 'service_identifier2', 'device_class']
    const time_breakdown_list = ['hour', 'day', 'week', 'month']
    ...
    return <FormContainer className={ this.props.className }>      
      ...
      <FormSection>
        ...
        <BreakdownItem 
            label="Row"
            breakdownList={ time_breakdown_list }
