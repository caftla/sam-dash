...
export default class Controls extends React.Component {
  ...
  render() {
    ...
    const breakdown_list = [ 'affiliate_id', 'publisher_id', 'sub_id', 'gateway', 'country_code', 'operator_code', 'gateway', 'handle_name', 'ad_name', 'scenario_name', 'get_sub_method', 'product_type', 'service_identifier1', 'service_identifier2', 'os_name', 'os_version', 'os_version1', 'brand_name', 'model_name', 'browser_name', 'browser_version', 'browser_version1', 'device_class', 'hour', 'day', 'week', 'month']
