...
class Subscriptions extends React.Component {
  ...
  render() {
    ...
    , Loaded: (data) => {
      ...
      return (<div flat_data={flat_data}>
      { flat_data.length == 0 
        ...
        : <div>
            <div style={ {padding: '0 12px'
                    ...
                    , padding: '1em 0.5em'
                    , backgroundColor: '#eee'} }
              onClick={e => this.export_to_excel(e)}>🗒 Export to Excel</div>
          <p style={{ padding: '8px'}}>Number of Subscriptions : { flat_data.length }</p>
          { flat_data.map((records, index) => (<div key={index}>
            <table id='table' style={{ paddingTop: '40px', borderBottom:'1.5pt solid grey', width:'90%' }}>
              <tr style={{padding: '8px', borderBottom: '1pt solid #f3f3f3' }}>
                <th style={{textAlign: 'left', whiteSpace: 'nowrap', padding: '8px', borderBottom: '1pt solid #f3f3f3', backgroundColor: '#f3f3f3' }}>STATUS</th>
                <td style={{padding: '8px', borderBottom: '1pt solid #f3f3f3' }}>{ records.optout?  'INACTIVE' : 'ACTIVE' }</td>
              </tr>
              { R.keys(records).map((keys) =>
                <tr>
                  <th style={{width: '20%', textAlign: 'left', whiteSpace: 'nowrap', padding: '8px', borderBottom: '1pt solid #f3f3f3', backgroundColor: '#f3f3f3'}}>{keys.toUpperCase().replace(/_/g, ' ')}</th>
                  <td style={{width: '80%', padding: '8px', whiteSpace: 'nowrap', borderBottom: '1pt solid #f3f3f3' }}>
